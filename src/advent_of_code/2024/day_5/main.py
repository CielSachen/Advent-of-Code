...
def get_relevant_rules(page_ordering_rules: list[PageOrderingRule], update: list[int]) -> list[PageOrderingRule]:
    return [
...
def solve_part_one(puzzle_input: str) -> None:
    ...
    correct_updates = [
        update for update in updates if is_correct_update(update, get_relevant_rules(page_ordering_rules, update))
    ]
...
def solve_part_two(puzzle_input: str) -> None:
    ...
    correctable_updates = [
        update for update in updates if not is_correct_update(update, get_relevant_rules(page_ordering_rules, update))
    ]
